...
public class Start {
	...
	public static void main(String[] args) {
		...
		linklistObj.append("ALOK");
		linklistObj.append("Kunal");;
		linklistObj.insert(0, "2Inset");
		linklistObj.insert(0, "1Inset");
		linklistObj.insert(0, "3Inset");
		linklistObj.remove(4);
		linklistObj.append("Kunal2");;
		//linklistObj.remove(2);
		//List<Integer> arrlistObj = new ArrayList<Integer>(5);
		//arrlistObj.add(5);
		//arrlistObj.add(6);	
		//linklistObj.append(arrlistObj);		
		System.out.print(linklistObj.toString());
